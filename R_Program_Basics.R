...
seq(from = 3, length = 3, by = 0.5) -> x1;x1
seq(from = 3, to=5, by = 0.5) -> x2;x2
...
myobject<-seq(1,10);myobject
myobject<-seq(from=1,length=10,by=1);myobject
myobject<-seq(from=1,length=10);myobject
seq(from=1,length=10)->myobject;myobject

class(myobject)
class(paste(myobject))
which(myobject==6)
logical_object=myobject<6;logical_object
...
x=5:7;x # 3 data points, integers
y=8:10;y
